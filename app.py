...
openai.api_base = "https://openai-powerbi-dev.openai.azure.com"
...
def generate_text(openAI_key, prompt, engine="Genpacttest"):
...
def generate_answer(question, openAI_key):
    ...
    answer = generate_text(openAI_key, prompt, "Genpacttest")
    return answer
...
app = demo.launch(share=True, server_name=0.0.0.0, server_port=os.getenv('PORT'))
